import { IWord } from '../../models/word.models';
...
export const DATA: IWord[] = [
  ...
  },
  {
    ...
    textMeaningTranslate:
      'Камера - это часть оборудования, которая делает снимки',
  ...
  },
  {
    ...
    textMeaning:
      'A <i>capital</i> is a city where a country’s government is based.',
    ...
    textMeaningTranslate:
      'Столица - это город, в котором базируется правительство страны',
